...
public class JMS2MessageDefaultPriority {
private static final Logger logger = LoggerFactory.getLogger(JMS2MessageDefaultPriority.class);
	
	public void sendReceiveMessage() throws NamingException, JMSException {
		...
		try(ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory();
			...
			for(int i = 0; i < 3; i++) {
				logger.info("Printing default message priority >>> {}", consumer.receive().getJMSPriority());
			}
		}
	}
}
