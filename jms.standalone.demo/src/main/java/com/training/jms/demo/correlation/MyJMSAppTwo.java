...
public class MyJMSAppTwo implements Runnable {
	private static final Logger logger = LoggerFactory.getLogger(MyJMSAppTwo.class);
	...
	public void createAndReceiveMessage() throws NamingException, JMSException {
		...
		try(ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory();
			...
			TextMessage textMessage = jmsContext.createTextMessage("[AppTwo] Hello Recevied...");
			textMessage.setJMSCorrelationID(messageReceived.getJMSMessageID());
			jmsContext.createProducer().send(messageReceived.getJMSReplyTo(), textMessage);
